...
class CricbuzzParser():
    ...
    def handleMatch(self,match):
        ...
        try:
            ...
            pass
        return "\n\n\nSeries="+series+"  Match Format="+mtype+"\nTeam"+match_desc+"\nVenu="+mground+"\nMatch State="+match_cstate+"\nMatch Status="+mstatus+"\nBatting team="+batting_team_name+"\nBowling team="+bowling_team_name+"\nBatting Team Runs="+bat_runs+"\nBatting Team Overs="+bat_overs+"\nBatting Team Wickets="+bat_wkts+"\nBowling Team Runs="+bowl_runs+"\nBowling Team Overs="+bowl_overs+"\nBowling Team Wickets="+bowl_wkts
